...
2. Refine your search results by using the **Accessibility, Type, Year, and URL filters**. The explanations are detailed below:
   ...
   *Onsite*: To view archived content that are only available at Level 11 of the [Lee Kong Chian Reference Library](https://www.nlb.gov.sg/VisitUs/BranchDetails/tabid/140/bid/329/Default.aspx?branch=National+Library+%2F+Lee+Kong+Chian+Reference+Library) due to copyright. Archived website that are only available onsite are denoted with a lock icon.<left><img src="\images\other-formats\archivedwebsites-lock.png" style="width:20px;" /></left> Please approach the counter at Level 11 for assistance.
