...
<img src="\images\getting-started\archivedwebsites-01.png" style="width:500px;" />
...
3. If you are searching for an **archived website**, we recommend using the following filters:
   ...
   <img src="\images\getting-started\archivedwebsites-02.png" style="width:500px;" />
...
4. If you are searching for an **archived webpage**, we recommend using the following filters:
   ...
   <img src="\images\getting-started\archivedwebsites-03.png" style="width:500px;" />
...
5. Where necessary, you can remove the applied filters by unchecking the filters on the left or clicking the grey boxes under the search bar.
   ...
   <img src="\images\getting-started\archivedwebsites-04.png" style="width:500px;" />

##  **Viewing the Archived Website**

Click on the record title to view the archived website. 

<img src="\images\getting-started\archivedwebsites-05.png" style="width:500px;" />

<img src="\images\getting-started\archivedwebsites-06.png" style="width:500px;" />
...
1. The link is pointing to another website (different URL) and was not archived as it was outside our archiving scope.

2. If it is a large website, our crawler may have archived only a portion of the website and not its entirety due to time and data size constraints. 

3. Only one page of the website has been selected for archiving, as only that webpage met our selection criteria for preservation. 

4. Sometimes the display of the archived website will also lead to an error message if you click on certain links (e.g. dropdown menus). When you encounter such errors, we suggest that you explore the archived website via its sitemap if it is available.

## **Browsing Web Archive Singapore**

You can also explore WAS through the Special Collections and Browse by Category.

<img src="\images\getting-started\archivedwebsites-07.png" style="width:500px;" />
...
<img src="\images\getting-started\archivedwebsites-08.png" style="width:500px;" />
...
<img src="\images\getting-started\archivedwebsites-09.png" style="width:500px;" />

Click on ‘Add to Citation’, found under each website record, to save it. 

<img src="\images\getting-started\archivedwebsites-10.png" style="width:500px;" />
